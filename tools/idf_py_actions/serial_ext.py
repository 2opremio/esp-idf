...
def action_extensions(base_actions: Dict, project_path: str) -> Dict:
    ...
    def monitor(action: str, ctx: click.core.Context, args: PropertyDict, print_filter: str, monitor_baud: str,
                encrypted: bool,
                no_reset: bool, timestamps: bool, timestamp_format: str, force_color: bool, retry_open: bool) -> None:
        """
        ...
        try:
            RunTool('idf_monitor', monitor_args, args.project_dir, build_dir=args.build_dir, hints=hints,
                    interactive=True, convert_output=True)()
        finally:
            signal.signal(signal.SIGINT, old_handler)

    def flash(action: str, ctx: click.core.Context, args: PropertyDict, force: bool, retry_open_serial: bool, extra_args: str) -> None:
        """
        ...
        env = {'ESPBAUD': str(args.baud), 'ESPTOOL_RETRY_OPEN_SERIAL': str(retry_open_serial), 'SERIAL_TOOL_EXTRA_ARGS': ';'.join(extra)}
    ...
    flash_options = BAUD_AND_PORT + [
        ...
        {
            'names': ['--retry-open-serial'],
            'help': 'Retry opening the serial port indefinitely',
            'envvar': 'ESPTOOL_RETRY_OPEN_SERIAL',
            'is_flag': True,
        },
        {
            'names': ['--extra-args'],
